...
import FeedbacksAdmin from "../../../components/sections/ia/admin/FeedbacksAdmin";
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-slate-200 px-5 md:px-10 py-4">
        <h1 className="text-bluePrimary font-bold text-lg">Feedbacks</h1>
        <p className="text-customGray text-xs mt-0.5">
          Opiniones de usuarios sobre las recomendaciones generadas
        </p>
      </div>
